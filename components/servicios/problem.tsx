	...
	return (
		<section className="mx-auto max-w-360 px-5 pb-24 sm:px-8 sm:pb-32 lg:px-10">
			<motion.div
				...
				whileInView="visible"
				viewport={viewport}
				className="border-border relative grid border-y lg:grid-cols-[0.8fr_0.9fr]"
			>
				...
				{/* The pain this service removes. Takes the right column; the illustration fills the left one. */}
				<div className="border-border border-b py-10 lg:col-start-2 lg:row-start-1 lg:border-b-0 lg:py-16 lg:pl-14">
				...
				<div className="relative py-10 lg:py-16 lg:pl-14 border-border border-t lg:col-start-2 lg:row-start-2">
					<motion.h3
						variants={item}
						transition={itemTransition}
