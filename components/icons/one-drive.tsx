...
const MicrosoftOneDrive = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} viewBox="0 0 1000 615">
		<defs>
			<radialGradient
				id="microsoft_onedrive__a"
				cx="-446.23"
				cy="850.24"
				r="6.99"
				fx="-446.23"
				fy="850.24"
				gradientTransform="matrix(28.87975 32.00675 53.69646 -48.39975 -32750.77 55564.7)"
			...
			<radialGradient
				id="microsoft_onedrive__b"
				cx="-463.71"
				cy="855.09"
				r="6.99"
				fx="-463.71"
				fy="855.09"
				gradientTransform="matrix(-126.93754 135.45874 101.23704 94.7798 -144561.83 -18444.24)"
				gradientUnits="userSpaceOnUse"
			>
				<stop offset=".17" stopColor="#23c0fe" />
				<stop offset=".53" stopColor="#1c91ff" />
			</radialGradient>
			<radialGradient
				id="microsoft_onedrive__c"
				cx="-478.67"
				cy="847.12"
				r="6.99"
				fx="-478.67"
				fy="847.12"
				gradientTransform="matrix(-30.17956 -23.43498 -52.80172 67.93278 30509.91 -68620.88)"
				gradientUnits="userSpaceOnUse"
			>
			...
			<radialGradient
				...
				fx="-484.89"
				fy="847.31"
				gradientTransform="matrix(-33.90072 -26.53382 -39.69188 50.66325 17714.49 -55348.26)"
				gradientUnits="userSpaceOnUse"
			>
			...
			<radialGradient
				id="microsoft_onedrive__f"
				cx="-465.3"
				cy="852.63"
				r="6.99"
				fx="-465.3"
				fy="852.63"
				gradientTransform="matrix(-101.35519 93.7574 146.5162 158.24743 -171232.53 -91444.13)"
				gradientUnits="userSpaceOnUse"
			>
			...
			<radialGradient
				...
				fx="-445.42"
				fy="847.35"
				gradientTransform="matrix(60.3777 22.14291 39.59688 -107.87213 -6264.92 101508.79)"
				gradientUnits="userSpaceOnUse"
			>
				<stop offset="0" stopColor="#fff" />
			...
			<radialGradient
				...
				fx="-468.67"
				fy="861.39"
				gradientTransform="matrix(-67.45933 53.77501 53.21816 66.68832 -76468.45 -32083.78)"
				gradientUnits="userSpaceOnUse"
			>
				<stop offset="0" stopColor="#4bfde8" />
			...
			<linearGradient
				...
				y1="2.44"
				y2="421.76"
				gradientTransform="matrix(1 0 0 -1 0 617.01)"
				gradientUnits="userSpaceOnUse"
			>
				<stop offset="0" stopColor="#0086ff" />
				<stop offset=".49" stopColor="#0bf" />
			</linearGradient>
		</defs>
		<path
			...
			style={{ fill: "url(#microsoft_onedrive__a)" }}
		/>
		<path
			...
			style={{ fill: "url(#microsoft_onedrive__b)" }}
		/>
		<path
			d="M240.99 142.19c-51.39 75.26-120.56 183.1-143.91 217.03-27.75 40.34-101.25 23.2-95.16-34.62a237.4 237.4 0 0 0-1.38 14.19C-9.51 489.22 119.43 614.14 279.88 614.14c176.84 0 598.58-203.81 555.9-408.02C790.8 86.1 664.36 0 521.07 0S285.94 76.36 241 142.19Z"
			style={{ fillOpacity: ".4", fill: "url(#microsoft_onedrive__c)" }}
		/>
		<path
			d="M240.99 142.19c-51.39 75.26-120.56 183.1-143.91 217.03-27.75 40.34-101.25 23.2-95.16-34.62a237.4 237.4 0 0 0-1.38 14.19C-9.51 489.22 119.43 614.14 279.88 614.14c176.84 0 598.58-203.81 555.9-408.02C790.8 86.1 664.36 0 521.07 0S285.94 76.36 241 142.19Z"
			style={{ fill: "url(#microsoft_onedrive__d)" }}
		/>
		<path
			d="M240.99 142.19c-51.39 75.26-120.56 183.1-143.91 217.03-27.75 40.34-101.25 23.2-95.16-34.62a237.4 237.4 0 0 0-1.38 14.19C-9.51 489.22 119.43 614.14 279.88 614.14c176.84 0 598.58-203.81 555.9-408.02C790.8 86.1 664.36 0 521.07 0S285.94 76.36 241 142.19Z"
			style={{ fill: "url(#microsoft_onedrive__e)", fillOpacity: ".6" }}
		/>
		<path
			d="M240.99 142.19c-51.39 75.26-120.56 183.1-143.91 217.03-27.75 40.34-101.25 23.2-95.16-34.62a237.4 237.4 0 0 0-1.38 14.19C-9.51 489.22 119.43 614.14 279.88 614.14c176.84 0 598.58-203.81 555.9-408.02C790.8 86.1 664.36 0 521.07 0S285.94 76.36 241 142.19Z"
			style={{ fillOpacity: ".9", fill: "url(#microsoft_onedrive__f)" }}
		/>
		<path
			...
			style={{ fill: "url(#microsoft_onedrive__g)" }}
		/>
		<path
			d="M277.34 614.23s422.24.77 493.86.77c129.97 0 228.8-98.16 228.8-212.69s-100.8-212.1-228.8-212.1-201.7 88.57-257.06 185.25c-64.87 113.29-147.62 237.41-236.8 238.77Z"
			style={{ fill: "url(#microsoft_onedrive__h)", fillOpacity: ".4" }}
		/>
		<path
			d="M277.34 614.23s422.24.77 493.86.77c129.97 0 228.8-98.16 228.8-212.69s-100.8-212.1-228.8-212.1-201.7 88.57-257.06 185.25c-64.87 113.29-147.62 237.41-236.8 238.77Z"
			style={{ fill: "url(#microsoft_onedrive__i)", fillOpacity: ".9" }}
		/>
	</svg>
)

export { MicrosoftOneDrive }
