			...
			>
				<div className="flex flex-col gap-3">
					...
					<p className="text-muted-foreground max-w-xl text-sm sm:text-base">
						Lo que ves acá son maquetas, prototipos y exploraciones. Si querés ver proyectos que hoy
						están corriendo en empresas reales, andá a la página de casos.
					</p>
				</div>

				<Link
					href="/casos"
					className="group bg-foreground text-background inline-flex shrink-0 items-center gap-3 self-start rounded-full px-5 py-3 text-sm font-medium transition-opacity hover:opacity-90 sm:self-center sm:text-base"
				>
					Ver casos
