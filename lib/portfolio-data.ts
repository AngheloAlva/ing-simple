...
export const portfolioProjects: ProjectData[] = [
	...
	},
	{
		...
		imageUrl: "/img/portfolio/algorithm-system-playground.png",
		...
		fullDescription:
			"Portfolio interactivo de algoritmos clásicos de ciencias de la computación renderizados en tiempo real. Incluye cuatro módulos: pathfinding (A*, Dijkstra, BFS, DFS), traversal de grafos, simulación discreta paso a paso y un dashboard de comparación de performance. Cada algoritmo está escrito desde cero, sin librerías externas, con la lógica pura separada de la UI y todo el estado serializado en query params para reproducir cualquier sesión compartiendo una URL.",
		category: "desarrollo-web",
		technologies: [
			"TypeScript",
			"Next.js",
		...
		liveUrl: "https://algorithm-systems-playground.vercel.app/",
		githubUrl: "https://github.com/AngheloAlva/algorithm-systems-playground",
		gradientColor: "#6366f1",
	},
	{
		id: "pipeline-operations-platform",
		imageUrl: "/img/portfolio/pipeline-operations-system.png",
		...
		fullDescription:
			"Aplicación web que unifica tres dominios de la operación de un oleoducto: monitoreo de flujo de crudo en tiempo cuasi-real (Cockpit), mantenimiento preventivo (CMMS) e integridad con protección catódica del trazado. Modela reglas físicas reales —balance volumétrico con corrección térmica, scheduling por criticidad y criterios NACE de corrosión— sobre datos sintéticos, con la lógica de dominio en un núcleo hexagonal puro testeado con Strict TDD (456 tests).",
		category: "desarrollo-web",
		technologies: [
			"Next.js",
			"React",
		...
		liveUrl: "https://pipeline-operations-platform.vercel.app/",
		githubUrl: "https://github.com/AngheloAlva/pipeline-operations-platform",
