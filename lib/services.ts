...
export type ServiceInclude = { title: string; desc: string };
...
export type ServicePage = {
  ...
  process: ServiceStep[];
  /** Tools/stack chips shown on the page. */
  tools: string[];
...
export const SERVICES: Service[] = [
  {
    ...
    page: {
      ...
      tools: ["Power BI", "Power Query", "SQL", "Excel", "Power Automate"],
  ...
  },
  {
    ...
    page: {
      ...
      tools: ["Power BI", "Excel", "Power Apps", "Power Automate", "SharePoint"],
