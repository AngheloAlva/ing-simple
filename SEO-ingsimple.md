...
- **La promesa de contacto es un correo.** El endpoint confirma al instante y promete respuesta en menos de 24 horas hábiles; toda la copy dice eso. No escribir "agenda", "llamada" ni "30 minutos" mientras no exista un calendario real.
- **Dos etiquetas de CTA:** "Pide tu diagnóstico gratis" (final de página) y "Conversemos" (nav, hero, tarjetas). Enlaces a servicios: "Ver {servicio}", nunca "Ver más".
